...
const EventVideoButton = React.forwardRef<HTMLButtonElement, EventVideoButtonProps>(
...
const EventVideoPlayer = React.forwardRef<HTMLDivElement, EventVideoPlayerProps>(
  ({ timestamp }, ref) => {
    return (
