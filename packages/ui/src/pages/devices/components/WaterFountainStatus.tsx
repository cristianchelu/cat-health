...
export interface WaterFountainState {
...
const WaterFountainStatus: React.FC<WaterFountainStatusProps> = ({
  ...
  const filterStatus = getFilterStatus(state.filterDaysRemaining);
  const waterStatus = getWaterStatus(state.waterDaysRemaining);
