// NO LONGER WORKING, USE ONLY AS REFERENCE
...
export class LitterboxStateTracker {
    ...
    private knownPresenceTol = 0.1; // ±10% band for confirming presence
    ...
    /**
     * Post-processes the transition history to create a cleaned-up sequence of state periods.
     */
